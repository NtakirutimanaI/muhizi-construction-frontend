...
export const SIDEBAR_SECTIONS: SidebarSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/admin/site-rules', icon: 'FaGavel', label: 'Site Rules', roles: [ROLES.ADMIN, ROLES.SITE_MANAGER, ROLES.MANAGER, ROLES.SITE_ENGINEER, ROLES.ENGINEERING_STUDIO, ROLES.MANAGING_DIRECTOR, ROLES.FINANCE_DIRECTOR, ROLES.CLIENT, ROLES.PARTNER] },
        ],
    },
    {
        label: 'HR',
    ...
    },
    {
        label: 'Admin',
        items: [
            { path: '/admin/messages', icon: 'FaEnvelope', label: 'Messages', roles: [ROLES.ADMIN, ROLES.SITE_MANAGER, ROLES.MANAGER, ROLES.MANAGING_DIRECTOR, ROLES.ENGINEERING_STUDIO] },
