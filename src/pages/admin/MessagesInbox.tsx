...
import { FaEnvelope, FaUser, FaPhone, FaBuilding, FaCheck, FaClock, FaCheckCircle, FaTrash, FaInbox, FaFileExcel, FaFilePdf, FaChevronLeft, FaChevronRight, FaPaperPlane, FaTimes } from 'react-icons/fa';
