...
import { FaChartBar, FaBullseye, FaEye, FaGem, FaSun, FaHandshake, FaRocket, FaSave, FaPlus, FaEdit, FaTrash } from 'react-icons/fa';
import type { Profile } from '../../../services/profileService';
import { useToast } from '../../../context/ToastContext';

type AboutTab = 'stats' | 'mission' | 'vision' | 'philosophy' | 'core-values' | 'why-choose-us' | 'cta';
