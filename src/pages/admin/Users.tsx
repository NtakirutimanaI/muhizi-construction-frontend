...
const ROLES = ['admin', 'managing_director', 'finance_director', 'site_engineer', 'engineering_studio', 'site_manager', 'manager', 'employee', 'client'];
...
const Users = () => {
    ...
    const roleColors: Record<string, string> = {
        ...
        site_manager: '#f59e0b', manager: '#8b5cf6', employee: '#6b7280', client: '#22c55e',
    };
