...
const AttendancePage = () => {
    ...
    const filtered = useMemo(() => {
        ...
        return data.filter(d => {
            ...
            if (toDate) { const end = new Date(toDate); end.setHours(23, 59, 59, 999); if (new Date(d.date) > end) return false; }
            return true;
        });
    }, [data, search, fromDate, toDate, getEmployeeName]);
        ...
        <div className="admin-page">
            ...
            <div className="admin-card">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                    <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>All Attendance Records</span>
