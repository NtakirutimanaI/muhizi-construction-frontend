                    ...
                    {sent ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                            <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.9rem', textAlign: 'center' }}>
                                If an account exists for <strong>{email}</strong>, an OTP code has been sent. Enter it on the next screen to set a new password.
                            </p>
                            <button
                                onClick={() => navigate(`/reset-password?email=${encodeURIComponent(email)}`)}
                                style={{
                                    padding: '0.9rem', fontSize: '1rem', fontWeight: 700, background: 'var(--primary)',
                                    color: '#fff', border: 'none', borderRadius: '10px', cursor: 'pointer', letterSpacing: '0.5px',
                                }}
                            >
                                Enter Reset Code
                            </button>
