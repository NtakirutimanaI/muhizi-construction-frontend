    ...
    return (
        <section data-nav-theme="light" className="section section-indicator" id="about" style={{
            ...
            <div className="container">
                ...
                <div style={{ width: '100vw', margin: '3rem calc(-50vw + 50%) 0', padding: '3rem 3.5rem 4rem', background: 'linear-gradient(180deg, #ffffff 0%, #ffffff 40%, #fde8d2 85%, #fbd5ab 100%)' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '280px repeat(3, 1fr)', gap: '1.75rem', maxWidth: '1400px', margin: '0 auto' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <p style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', color: '#f97316', fontWeight: 700, fontSize: '0.8rem', letterSpacing: '0.05em', textTransform: 'uppercase', margin: '0 0 1rem' }}>
                                <span style={{ width: '34px', height: '2px', background: '#f97316', display: 'inline-block' }} />
                                What We Offer
                            </p>
                            <h2 style={{ color: '#101223', fontSize: '2.2rem', fontWeight: 700, lineHeight: 1.2, margin: '0 0 2rem' }}>
                                Driven By Quality, Defined By Results
                            </h2>
                            <a href="#services" className="learn-more" style={{ background: '#f97316', borderColor: '#f97316', color: '#fff', display: 'inline-flex', alignItems: 'center', gap: '0.75rem', padding: '0 0 0 1.75rem', borderRadius: '9999px', fontSize: '0.875rem', fontWeight: 500, letterSpacing: '0.025em', textDecoration: 'none', transition: 'all 0.2s ease', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', width: 'fit-content' }}>
                                VIEW ALL SERVICES
                                ...
                                <div key={idx} style={{ borderRadius: '14px', overflow: 'hidden', background: '#fff', border: '1px solid rgba(15,18,34,0.06)', boxShadow: '0 4px 20px rgba(15,18,34,0.07)' }}>
                                    ...
                                    <div style={{ padding: '1.5rem 1.6rem 1.7rem' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1.1rem' }}>
                                            <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: '#fdece0', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                                <Icon style={{ color: '#f97316', fontSize: '1.2rem' }} />
                                            </div>
                                            <h3 style={{ color: '#101223', fontSize: '1.1rem', fontWeight: 700, margin: 0, lineHeight: 1.3 }}>{item.title}</h3>
                                        </div>
                                        <div style={{ height: '1px', background: '#e9e9ec', margin: '0 0 1rem' }} />
                                        <p style={{ color: '#6b7280', fontSize: '0.9rem', lineHeight: 1.65, margin: 0 }}>{item.description}</p>
                                    </div>
                                </div>
                            );
                        })}
